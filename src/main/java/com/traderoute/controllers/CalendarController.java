...
public class CalendarController implements Initializable {
    ...
    public List<Meeting1> getMeetings() {
        ...
        meetings.add(new Meeting1(new GregorianCalendar(2021, 3, 11, 16, 16, 00),
                new GregorianCalendar(2021, 3, 11, 17, 16, 00)));
        meetings.add(new Meeting1(new GregorianCalendar(2021, 3, 11, 9, 16, 00),
                new GregorianCalendar(2021, 3, 11, 10, 16, 00)));
        return meetings;
    }
