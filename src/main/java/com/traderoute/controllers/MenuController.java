    ...
    */
    public static ObservableList<Product> getExampleProducts() {
        ...
        products.add(new Product("Big Time Food Company", "24 oz pickles", new BigDecimal("3.59"), new BigDecimal("0.29"),
                ...
                new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),
                new BigDecimal("0.0"),new BigDecimal("0.0"), getExtendedSkus()));
        products.add(new Product("Big Time Food Company", "12 oz pickle juice", new BigDecimal("1.49"), new BigDecimal("0.14"),
                new BigDecimal("1.35"), new BigDecimal("1.29"), new BigDecimal("0.78"), new BigDecimal("-1.20"), new BigDecimal("0.0"),
                new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),
                new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),
        ...
        products.add(new Product("Small Time Food Company", "12 oz pickle juice", new BigDecimal("1.49"), new BigDecimal("0.14"),
                ...
                new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),
                new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"), getExtendedSkus()));
    ...
    public static ObservableList<Sku> getExtendedSkus() {
        ...
        extendedSkus.add(new Sku("Dill Pickles", 6, new BigDecimal("2.40"), new BigDecimal("15.0"),new BigDecimal("14.40"),new BigDecimal("0.6"),
                new BigDecimal("0.33"), new BigDecimal("12.00"), new BigDecimal("8.00"), new BigDecimal("6.00"), new BigDecimal("3.5"),new BigDecimal("3.5"),new BigDecimal("5.5"),20,8,160,new BigDecimal("53.00"),2500,18,9, "859994-00600 6","859994-00606 8",new BigDecimal("3.59")));
        extendedSkus.add(new Sku("Dill Pickles 1", 6, new BigDecimal("2.40"), new BigDecimal("15.0"),new BigDecimal("14.40"),new BigDecimal("0.6"),
                new BigDecimal("0.33"), new BigDecimal("12.00"), new BigDecimal("8.00"), new BigDecimal("6.00"), new BigDecimal("3.5"),new BigDecimal("3.5"),new BigDecimal("5.5"),20,8,160,new BigDecimal("53.00"),2500,18,9, "859994-00600 6","859994-00606 8",new BigDecimal("3.59")));
        extendedSkus.add(new Sku("Dill Pickles 2", 6, new BigDecimal("2.40"), new BigDecimal("15.0"),new BigDecimal("14.40"),new BigDecimal("0.6"),
                new BigDecimal("0.33"), new BigDecimal("12.00"), new BigDecimal("8.00"), new BigDecimal("6.00"), new BigDecimal("3.5"),new BigDecimal("3.5"),new BigDecimal("5.5"),20,8,160,new BigDecimal("53.00"),2500,18,9, "859994-00600 6","859994-00606 8",new BigDecimal("3.59")));
        extendedSkus.add(new Sku("Dill Pickles 3", 6, new BigDecimal("2.40"), new BigDecimal("15.0"),new BigDecimal("14.40"),new BigDecimal("0.6"),
                new BigDecimal("0.33"), new BigDecimal("12.00"), new BigDecimal("8.00"), new BigDecimal("6.00"), new BigDecimal("3.5"),new BigDecimal("3.5"),new BigDecimal("5.5"),20,8,160,new BigDecimal("53.00"),2500,18,9, "859994-00600 6","859994-00606 8",new BigDecimal("3.59")));
        extendedSkus.add(new Sku("Dill Pickles 4", 6, new BigDecimal("2.40"), new BigDecimal("15.0"),new BigDecimal("14.40"),new BigDecimal("0.6"),
                new BigDecimal("0.33"), new BigDecimal("12.00"), new BigDecimal("8.00"), new BigDecimal("6.00"), new BigDecimal("3.5"),new BigDecimal("3.5"),new BigDecimal("5.5"),20,8,160,new BigDecimal("53.00"),2500,18,9, "859994-00600 6","859994-00606 8",new BigDecimal("3.59")));
