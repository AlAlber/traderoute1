...
public class MenuController implements Initializable {
    ...
    public void switchToProductClassReporting(ActionEvent event)throws IOException {
        FXMLLoader productClassReportingLoader = App.createFXMLLoader("retailerSelection");
        App.setSceneRoot(productClassReportingLoader.load());

        RetailerSelectionController retailerSelectionController = productClassReportingLoader.getController();
        retailerSelectionController.setRetailers(getExampleRetailers());
    }
...
//        ProductsPricingController productsPricingController = productsPricingLoader.getController();
//        productsPricingController.setRetailers(getExampleRetailers());
    }
    ...
    */
    public static ObservableList<Product> getExampleProducts() {
        ...
        products.add(new Product("Small Time Food Company", "32 oz mixes", new BigDecimal("3.59"), new BigDecimal("0.29"),
                new BigDecimal("3.30"), new BigDecimal("2.99"), new BigDecimal("1.60"), new BigDecimal("-1.05"), new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0"),new BigDecimal("0.0")));
        return products;
    }
