...
public class NumberEditCell<Object, Number> extends TableCell<Object, Number>{
        private String pre;
        private String post;
        ...
        public NumberEditCell(String pre, String post) {
...
//            Product product = getTableRow().getItem();
            if (getItem() instanceof Integer){
                if (text.equals("")){
                    commitEdit((Number) Integer.valueOf(0));
                }else {
        ...
        private String getString() {
            if (getItem() instanceof BigDecimal) {
                return getItem() == null ? "" :pre + ((BigDecimal) getItem()).setScale(2, RoundingMode.HALF_UP).toString() +post;
            }
        ...
        public void commitEdit(Number item) {
            ...
            if (!isEditing() && !item.equals(getItem())) {
                ...
                if (table != null) {
                    ...
                    TableColumn.CellEditEvent<Object, Number> event = new TableColumn.CellEditEvent<>(
                            table, new TablePosition<Object,Number>(table, getIndex(), column),
