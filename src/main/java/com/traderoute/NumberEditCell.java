...
import java.math.RoundingMode;
import java.util.regex.Pattern;
public class NumberEditCell extends TableCell<Object, BigDecimal>{
        private String pre;
        private String post;
...
//            }
        ...
        public void commitEdit(BigDecimal item) {
            ...
            if (!isEditing() && !item.equals(getItem())) {
                ...
                if (table != null) {
                    TableColumn<Object, BigDecimal> column = getTableColumn();
                    TableColumn.CellEditEvent<Object, BigDecimal> event = new TableColumn.CellEditEvent<>(
                            table, new TablePosition<Object,BigDecimal>(table, getIndex(), column),
